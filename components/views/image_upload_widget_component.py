...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.preview_image = Image(
            page, f'{identifier}-image-upload-widget-preview-image', 'Upload Widget Image Preview'
        )

        self.image_upload_info_icon = Icon(
            page, f'{identifier}-image-upload-widget-info-icon', 'Upload Widget Info Icon'
        )
        self.image_upload_info_title = Text(
            page, f'{identifier}-image-upload-widget-info-title-text', 'Upload Widget Info Title'
        )
        self.image_upload_info_description = Text(
            page, f'{identifier}-image-upload-widget-info-description-text', 'Upload Widget Info Description'
        )
